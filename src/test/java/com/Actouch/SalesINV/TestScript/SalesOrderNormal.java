...
import com.Actouch.SalesINVNorm.pageObjectRepository.SOPaymentLater;
		 ...
		 WebDriverCommonlib.waitForPageToLoad();
			String custID = SO_Excellib.getExcelDat("SO", 04, 8);
			 ...
			 expected = expected.setScale(2, BigDecimal.ROUND_HALF_UP);	
			  ...
			  payLtr.payltr(custID, prodID, Qnty, unitp, taxCode);
	 ...
	 public void SaleIN_MultiProduct_TC_22() throws Exception
	 {
		 WebDriverCommonlib.waitForPageToLoad();
			...
			GrossTotalExp = GrossTotalExp.setScale(2, BigDecimal.ROUND_HALF_UP);
				...
				SOMutiproduct SOMultiprod =new SOMutiproduct();
				SOMultiprod.multiproduct(custID);
			     ...
			     SOMutiproduct.payltrDB("jdbc:mysql://178.162.192.40:3306/", "actouchuser", "actouchuser","select * from actouch.so_mstr where  ENTITY_ID = 261595686 and so_id ='"+SOMutiproduct.exp+"'", "CUST_ID","CUST_NAME","TOTAL_AMT","TOTAL_TAX");
