...
public class DirectRecept  extends DRINVDataProvider {
	static WebDriver driver;
	@Test(priority = 1)
	public void DRINV_Login_TC_1() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
