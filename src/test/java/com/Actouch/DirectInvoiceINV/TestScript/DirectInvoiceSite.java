...
import com.Actouch.DirectInvoiceINVSite.pageObjectRepository.DIMultiProd;
import com.Actouch.DirectInvoiceINVSite.pageObjectRepository.DIPaymentLater;
...
public class DirectInvoiceSite {
	static WebDriver driver;

	SO_Excellib DI_Excellib = new SO_Excellib("D:\\Selenium\\DirectInvoiceSite.xlsx");
 ...
 String usrid = DI_Excellib.getExcelDat("DII", 03, 03);
	...
	public void DIINV_payltr_TC_2() throws Exception, InvalidFormatException, IOException 
	{
		...
		DIPytr.payltr( Site,custID, prodID, Qnty, unitp);
	...
	public void DIINV_MultiProduct_TC_16() throws Exception
	{
		...
		MultiProd.payltr(Site, custID);
		 ...
		 DIMultiProd.payltrDB("jdbc:mysql://178.162.192.40:3306/", "actouchuser", "actouchuser","select * from actouch.shp_mstr where  ENTITY_ID = 651298674 and Invoice_ID ='"+DIMultiProd.exp+"'", "CUST_ID","CUST_NAME","TOTAL_AMT","TOTAL_TAX");
		 ...
		 Softass.assertEquals(Total_TXT, TotalTaxExp,"Total Tax coming as wrong ");
			...
			Softass.assertEquals(Total_amt,GrossTotalExp,"total amount not correct");
			 ...
			 DIMultiProd.payltrDB2("jdbc:mysql://178.162.192.40:3306/", "actouchuser", "actouchuser", "select * from actouch.tax_hist where ENTITY_ID = 651298674 and DOC_ID='"+DIMultiProd.exp+"'order by  sl_no asc", "TAX_ID", "TAXABLE_AMT", "GROSS_AMT", "SGST_TAX_AMT", "CGST_TAX_AMT");
			 Softass.assertAll();
