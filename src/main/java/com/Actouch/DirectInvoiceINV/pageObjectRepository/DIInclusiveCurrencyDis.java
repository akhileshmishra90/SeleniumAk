...
public class DIInclusiveCurrencyDis {
	...
	public static String amt;
	   ...
	   @FindBy(xpath="//input[@data-bind='checked: chkInclude, enable:canInclude']")
	   WebElement IncludeChk;
	  ...
	  WebElement Searchext;
	   ...
	   public void payltr(String Customer_Id,String Product_Id,String Quantity,String unit_price,String LineDis,String taxCode1) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
