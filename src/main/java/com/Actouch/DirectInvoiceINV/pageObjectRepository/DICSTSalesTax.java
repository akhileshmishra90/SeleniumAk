...
public static String amt;
	  ...
	  WebElement Searchext;
	   ...
	   public void payltr(String Customer_Id,String Product_Id,String Quantity,String unit_price,String EnableSalesTax,String salestax) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
		 ...
		 Thread.sleep(1000);
		  ...
		  EnableSalesTaxEdt.clear();
		  EnableSalesTaxEdt.sendKeys(EnableSalesTax);
