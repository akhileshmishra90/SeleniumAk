...
public class DIMUOMBatchable {
	...
	public static String amt;
	  ...
	  WebElement Searchext;
	   ...
	   public void payltr(String Customer_Id,String Product_Id,String Quantity,String unit_price,String Batch,String IssueUMO ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
	 	...
	 	Browser.driver.findElement(By.xpath(".//*[@id='taxCalc']/tbody/tr["+i+"]/td[13]/div/span/input")).sendKeys(IssueUMO);
