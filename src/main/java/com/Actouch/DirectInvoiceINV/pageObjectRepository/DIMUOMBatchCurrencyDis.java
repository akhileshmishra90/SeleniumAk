...
public class DIMUOMBatchCurrencyDis {
	public static String amt;
	  ...
	  WebElement Searchext;
	   ...
	   public void payltr(String Customer_Id,String Product_Id,String Batch,String Quantity,String SecUOM,String unit_price,String LineDis,String taxCode1) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
		  ...
		  Thread.sleep(2000);
			 ...
			 if(batch.equals(Batch))
			 {
				 Browser.driver.findElement(By.xpath(".//*[@id='taxCalc']/tbody/tr["+i+"]/td[1]/input")).click();
				  ...
				  Browser.driver.findElement(By.xpath(".//*[@id='taxCalc']/tbody/tr["+i+"]/td[13]/div/span/input")).sendKeys(SecUOM);
