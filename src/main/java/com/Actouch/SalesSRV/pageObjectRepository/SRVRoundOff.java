...
public class SRVRoundOff {
	...
	WebElement TotalEdt;
	@FindBy(xpath="//input[@data-bind='value: SOService.roundOff']")
	...
	WebElement ConfirmEdt;
	 @FindBy(xpath="//input[@aria-controls='SOTable']")
	   ...
	   WebElement actval;
	public void payLtr(String Cust,String Desc,String Category,String Unitprice,String RoundOff) throws InterruptedException
	{
