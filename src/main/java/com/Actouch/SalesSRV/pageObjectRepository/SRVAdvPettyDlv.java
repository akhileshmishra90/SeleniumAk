...
public class SRVAdvPettyDlv {
	...
	WebElement ConfirmEdt;
	 @FindBy(xpath="//input[@aria-controls='SOTable']")
	   ...
	   WebElement actval;
	   public void ReceiveAdvCash(String Cust,String Desc,String Category,String Unitprice,String Advanced,String paymode,String Deliver ) throws InterruptedException
	   {
