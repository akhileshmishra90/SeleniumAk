...
public class SRVCashOnHand {
	...
	WebElement ConfirmEdt;
	 @FindBy(xpath="//input[@aria-controls='SOTable']")
	   ...
	   WebElement actval;
	   public void PayNowCashonHand(String Cust,String Desc,String Category,String Unitprice,String Paytype,String paymode ) throws InterruptedException
	   {
