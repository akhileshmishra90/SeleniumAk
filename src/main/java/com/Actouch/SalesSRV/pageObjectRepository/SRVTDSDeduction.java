...
public class SRVTDSDeduction {
	...
	WebElement ConfirmEdt;
	 @FindBy(xpath="//input[@aria-controls='SOTable']")
	   ...
	   WebElement actval;
	public void TDSDeduction(String Cust,String Desc,String Category,String Unitprice,String taxCode1 ) throws InterruptedException
	{
