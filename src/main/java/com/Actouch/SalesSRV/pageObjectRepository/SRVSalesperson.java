...
public class SRVSalesperson {
	...
	WebElement ConfirmEdt;
	 @FindBy(xpath="//input[@aria-controls='SOTable']")
	   ...
	   WebElement actval;
	public void payLtr(String Cust,String salesPerson,String Desc,String Category,String Unitprice ) throws InterruptedException
	{
