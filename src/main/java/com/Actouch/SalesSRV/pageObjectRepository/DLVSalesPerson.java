...
public void FullServ(String SalesPerson) throws InterruptedException
{
	...
	Thread.sleep(2000);
	SalesPersonEdt.sendKeys(SalesPerson);
	act.sendKeys(Keys.ARROW_DOWN).perform();
	act.sendKeys(Keys.ENTER).perform();
	selectServ.click();
	Receiveall.click();
