...
public class SOBatchableItem {
   ...
   WebElement actval;
   public void batchableprod(String Customer_Id,String Product_Id,String Quantity,String unit_price,String taxCode,String Batch) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
	...
	amt = gettingTotalAmount.getText();
	  ...
	  searchtxt.sendKeys(exp);
	   String act2 = actval.getText();
	    Assert.assertEquals(act2, exp,"Batchable product after saving case == fail");
