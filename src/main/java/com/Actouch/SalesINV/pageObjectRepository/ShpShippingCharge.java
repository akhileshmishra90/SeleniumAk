...
public class ShpShippingCharge {
...
WebElement Result;
public void ShipShippingCharges(String shipcharge ) throws InterruptedException
{
...
String actual = Result.getText() ;
 Assert.assertEquals(actual, Excepted, "ShpShippingCharge ==fail");
 System.out.println("ShpShippingCharge ==pass");
