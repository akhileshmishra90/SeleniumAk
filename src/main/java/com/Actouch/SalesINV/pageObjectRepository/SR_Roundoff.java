...
public class SR_Roundoff {
	public static String amt;
		...
		WebElement Result;
		public void SRRoundOff(String Roundoff) throws InterruptedException
		 {
	 	...
	 	selectProd.click();		   	
		   ...
		   issueQnty.sendKeys(Qty);			
		   	...
		   	String actual = Result.getText();
		   	 Assert.assertEquals(actual, Excepted, "sales return Roundoff ==fail");
		   	 System.out.println("sales return Roundoff ==pass");
