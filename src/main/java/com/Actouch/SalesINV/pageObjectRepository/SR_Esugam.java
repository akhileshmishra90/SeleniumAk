...
public class SR_Esugam {
	...
	WebElement Result;
	public void ESugsm(String ESugam) throws InterruptedException
	 {
	   ...
	   issueQnty.sendKeys(Qty);		
		...
		Esugam.clear();	   	
	   	...
	   	RsoSearch.sendKeys(Excepted);
	   	 ...
	   	 Assert.assertEquals(actual, Excepted, "sales return E sugam number ==fail");
	   	 System.out.println("sales return E sugam number ==pass");
