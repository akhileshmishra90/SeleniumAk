...
@FindBy(id ="btnSave")
   ...
   WebElement actval;
   public void ShpByHand(String Customer_Id,String Product_Id,String Quantity,String unit_price,String taxCode ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
	...
	act.sendKeys(Keys.ENTER).perform();
	  ...
	  Thread.sleep(7000);
	   ...
	   String act2 = actval.getText();
	    Assert.assertEquals(act2, exp,"Shipment By Hand after saving case == fail");
  		System.out.println("Shipment By Hand after saving case == pass");
	 }
}
