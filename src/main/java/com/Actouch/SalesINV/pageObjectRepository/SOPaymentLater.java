...
public class SOPaymentLater {
	...
	@FindBy(xpath="(//input[@data-bind='checked: chkSelectAll '])[1]")
   ...
   WebElement actval;
   public void payltr(String Customer_Id,String Product_Id,String Quantity,String unit_price,String taxCode,String PayMentType  ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
