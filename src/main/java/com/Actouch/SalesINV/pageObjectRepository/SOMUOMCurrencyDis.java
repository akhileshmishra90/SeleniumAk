...
public class SOMUOMCurrencyDis {
	...
	@FindBy(xpath=".//*[@id='taxCalc']/tbody/tr[2]/td[12]/input")
	WebElement qntEdt;
	@FindBy(xpath="//div[@data-bind='visible : !showMuom()']/span/input")
	WebElement SecUOMEdt;
   ...
   WebElement actval;
   public void ProdTaxDis(String CustId,String ProdId,String Quantity,String SecUOM,String unitPrice,String Discount,String taxCode1) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
	 ...
	 prdSo_1Edt.sendKeys(ProdId);
	   Thread.sleep(2000);
	    ...
	    qntEdt.sendKeys(Quantity);
		   SecUOMEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),SecUOM);
