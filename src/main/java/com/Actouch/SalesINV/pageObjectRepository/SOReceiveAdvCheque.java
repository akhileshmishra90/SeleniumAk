...
public class SOReceiveAdvCheque {
	...
	WebElement paytype;
	@FindBy(xpath="//a[contains(text(),'HDFC')]")
	...
	WebElement actval;
	public void RcvAdvcheque(String Customer_Id,String Product_Id,String Quantity,String unit_price,String taxCode,String Adv_money,String ChequeNo, String ReceiveBank ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
