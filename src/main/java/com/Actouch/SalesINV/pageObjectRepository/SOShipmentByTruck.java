...
public class SOShipmentByTruck {
	//shipment by truck
   ...
   WebElement actval;
   public void ShpByTruck(String Customer_Id,String Product_Id,String Quantity,String unit_price,String taxCode ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
 ...
 Browser.driver.findElement(By.xpath("//table[@id='SODetailsTable']/tbody/tr/td[9]/div/div/span[text()='Tax Details']")).click();
	  ...
	  Thread.sleep(7000);
	   ...
	   String act2 = actval.getText();
	    Assert.assertEquals(act2, exp,"Shipment By Truck after saving case == fail");
  		System.out.println("Shipment By Truck after saving case == pass");
	   }
