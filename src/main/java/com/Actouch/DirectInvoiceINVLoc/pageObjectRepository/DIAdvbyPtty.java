...
public class DIAdvbyPtty {
	...
	public static String amt;
	  ...
	  WebElement Searchext;
	   ...
	   public void payltr(String Customer_Id,String Product_Id,String Quantity,String unit_price,String Advanced,String PayMode) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
