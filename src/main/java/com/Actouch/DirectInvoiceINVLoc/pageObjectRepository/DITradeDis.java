...
public class DITradeDis {
	public static String amt;
	  ...
	  @FindBy(xpath=".//*[@id='taxCalc']/tbody/tr[1]/td[13]/input")
	   ...
	   WebElement TotalEdt;
	   @FindBy(xpath="//span[@data-bind='text: DIInventory.overallDiscType']")
	   WebElement DisCountType;
	   @FindBy(xpath="//span[@data-bind='text: DIInventory.discMethodType2']")
        WebElement TradeDis;
	  ...
	  WebElement Searchext;
	   ...
	   public void payltr(String Customer_Id,String Product_Id,String Quantity,String unit_price,String Discount ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
