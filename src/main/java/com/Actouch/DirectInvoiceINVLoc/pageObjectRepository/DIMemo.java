...
public static String amt;
	  ...
	  WebElement Searchext;
	   ...
	   public void payltr(String Customer_Id,String Product_Id,String Quantity,String unit_price,String Memo) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
		 ...
		 Thread.sleep(1000);
		  ...
		  Thread.sleep(2000);
		   ...
		   String Mn = MemoEdt.getAttribute("value");
		   int ln = Mn.length();
		   Assert.assertTrue(kh >= ln , "Memo lenth is less than or equal to 195 == fail");
