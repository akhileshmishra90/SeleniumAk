...
public class DIAvdChq {
	...
	WebElement savingcheq;
	  ...
	  WebElement Searchext;
	   ...
	   public void payltr(String Customer_Id,String Product_Id,String Quantity,String unit_price,String Advanced,String PayMode,String ChequeNo,String RecvdbankName) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
		 ...
		 EnableAdvanced.click();
		 AdvEdt.sendKeys(Advanced);
		 PayModeEdt.clear();
