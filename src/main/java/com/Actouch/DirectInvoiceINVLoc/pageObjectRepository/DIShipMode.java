...
public static String amt;
	  ...
	  @FindBy(xpath=".//*[@id='taxCalc']/tbody/tr[1]/td[13]/input")
	   ...
	   @FindBy(id="deliveryMode-select")
	   WebElement ShipmodeEdt;
	  ...
	  WebElement Searchext;
	   ...
	   public void payltr(String Customer_Id,String Product_Id,String Quantity,String unit_price,String Shipmode ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
		 ...
		 Thread.sleep(1000);
		  ...
		  Thread.sleep(2000);
		   ...
		   ShipmodeEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),Shipmode);
