...
public class DIPayNowSingleChq {
	...
	public static String amt;
	  ...
	  WebElement Searchext;
	   ...
	   public void paySgChq(String Customer_Id,String Product_Id,String Quantity,String unit_price,String PayType,String PayMode ,String ChequeNo,String RecvdbankName ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
		 ...
		 Thread.sleep(1000);
		  ...
		  chequeNo.sendKeys(ChequeNo);
		   ...
		   WebDriverCommonlib.waitForElementPresent(SaveEdt);
		   SaveEdt.click();
		   AfterSaveEdt.click();
