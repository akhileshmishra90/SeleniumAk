...
public class PRR_FullReturn {
	public static String amt;
@FindBy(xpath="//input[@aria-controls='POTable']")////input[@aria-controls='PORTable']
...
WebElement Result;
public void FullReturn(String Reason) throws InterruptedException
{
