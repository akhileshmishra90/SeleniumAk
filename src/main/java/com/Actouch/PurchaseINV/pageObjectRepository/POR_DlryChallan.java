...
public class POR_DlryChallan {
	public static String amt; 
	 ...
	 WebElement Result;
	 public void FullreceiptDlry(String Delivery) throws InterruptedException
	 {
