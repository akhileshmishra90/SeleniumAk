...
public class POPayAdvCashOnHand {
	
	//Receive Advanced CashOnHand with tax
	...
	WebElement paytype;
	@FindBy(xpath="//a[contains(text(),'Cash on Hand')]")
	...
	WebElement actval;
	public void RcvAdvcashRecp(String Supp_Id,String Product_Id,String Quantity,String unit_price,String taxCode,String Adv_money  ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
	 ...
	 amt = getTotalAmount.getText();
	  ...
	  Thread.sleep(7000);
	   ...
	   String act2 = actval.getText();
	    Assert.assertEquals(act2, exp,"Receive Advance cash on hand after saving case == fail");
			System.out.println("Receive Advanced cash on hand  after saving case == pass");
	   }
