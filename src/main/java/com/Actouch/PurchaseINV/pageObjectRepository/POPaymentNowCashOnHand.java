...
public class POPaymentNowCashOnHand {
    ...
    WebElement actval;
    public void payNowCash (String Supp_Id,String prod_id,String Quantity,String unit_price,String PayMentType,String PaymentMode) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
