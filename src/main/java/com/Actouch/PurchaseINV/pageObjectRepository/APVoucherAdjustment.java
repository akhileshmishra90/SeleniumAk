...
public class APVoucherAdjustment {
	...
	WebElement PayAll;
	@FindBy(xpath="//table[@id ='table1']/tbody/tr[1]/td[2]/span/input") 
	WebElement Apvocher;
	...
	WebElement Result;
	public void Voucher(String Account,String Amount) throws InterruptedException
	{
