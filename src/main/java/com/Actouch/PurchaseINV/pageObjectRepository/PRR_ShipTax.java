...
public class PRR_ShipTax {
	...
	WebElement Result;
	public void FullReturnShpC(String Reason,String ShipCharge,String ShipTax,String ShippingTax ) throws InterruptedException
	{
...
ShipTaxEdt.clear();
		 Thread.sleep(101);
		 ShipTaxEdt.sendKeys(ShipTax);
		  act.sendKeys(Keys.ARROW_DOWN).perform();
		  act.sendKeys(Keys.ENTER).perform();
		 ShipChargeEdt.sendKeys(ShipCharge);
		   ShippingTaxEdt.sendKeys(ShippingTax);
		   act.sendKeys(Keys.ARROW_DOWN).perform();
		   act.sendKeys(Keys.ENTER).perform();
