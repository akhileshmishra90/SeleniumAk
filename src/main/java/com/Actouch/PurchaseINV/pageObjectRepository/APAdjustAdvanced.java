...
public class APAdjustAdvanced {
	...
	WebElement PayAll;
	@FindBy(xpath="//input[@data-bind='checked: AccountPayable.inAdvVouchers,enable: AccountPayable.hasinAdvVouchers']")
	WebElement EnableAdv;
	...
	WebElement Result;
	public void AdjustAdv() throws InterruptedException
	{
