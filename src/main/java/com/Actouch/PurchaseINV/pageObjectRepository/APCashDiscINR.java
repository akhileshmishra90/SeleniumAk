...
public class APCashDiscINR {
	...
	WebElement DiscEdt;
	@FindBy(xpath="//span[@data-bind='text: AccountPayable.discType2']")
	WebElement InrType;
	...
	WebElement Result;
	public void FullpaymentDiscINR(String Disc) throws InterruptedException
	{
