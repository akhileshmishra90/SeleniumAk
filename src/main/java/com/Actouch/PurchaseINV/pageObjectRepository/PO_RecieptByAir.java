...
public class PO_RecieptByAir {
	...
	@FindBy(id="poInvenotryshipMode-select")
	WebElement shipMode;
   ...
   WebElement actval;
   public void ShpByAir(String Supp_Id,String Product_Id,String Quantity,String unit_price,String taxCode ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
	 ...
	 Taxmodel.click();
	  ...
	  Thread.sleep(7000);
	   ...
	   String act2 = actval.getText();
	    Assert.assertEquals(act2, exp,"ShipmentByAir after saving case == fail");
  		System.out.println("ShipmentByAir after saving case == pass");
	     }
