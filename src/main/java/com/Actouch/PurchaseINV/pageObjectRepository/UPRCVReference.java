...
public class UPRCVReference {
	...
	WebElement Result;
	public void ReFerence(String Reference,String AmtRef) throws InterruptedException
	{
		...
		ActionsEdt.click();
		UpdateRCV.click();
		ReferenceEDT.sendKeys(Keys.chord(Keys.CONTROL,"a"),Reference);
		String Expected= ReferenceEDT.getAttribute("value");
		AmtRefEDT.sendKeys(Keys.chord(Keys.CONTROL,"a"),AmtRef);
		SaveEDT.click();
		OKEdt.click();
		Thread.sleep(3000);
		SearchPOR.sendKeys(Exp);
