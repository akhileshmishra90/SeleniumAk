...
public class POR_RejectedQty {
 ...
 @FindBy(xpath="//table[@id='POTable']/tbody/tr/td[5]")
	 ...
	 WebElement Result;
	 public void FullreceiptScrab(String RemQty,String Reject) throws InterruptedException
	 {
