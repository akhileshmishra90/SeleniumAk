...
public class PRR_CashDisINR {
	...
	@FindBy(xpath=".//*[@id='table1']/tbody/tr[3]/td[2]/div/div[2]/button")
	 ...
	 @FindBy(xpath="//span[@data-bind='text: PRRInventory.discType2']")
	 WebElement InrType;
	...
	WebElement Result;
	public void FullReturnDisI(String Reason,String Dis) throws InterruptedException
	{
