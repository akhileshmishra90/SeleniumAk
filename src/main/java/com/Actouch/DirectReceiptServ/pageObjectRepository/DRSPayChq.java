...
public class DRSPayChq {
 ...
 public static BigDecimal TOTAL_AMT;
	...
	WebElement Result;
	public void payltr(String SuppID,String Desc,String Category,String SerPrice,String Bank) throws InterruptedException, ClassNotFoundException, SQLException
	{
		...
		PaytyEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),"Now");
		act.sendKeys(Keys.ARROW_DOWN).perform();
		act.sendKeys(Keys.ENTER).perform();
		PayModeEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),Bank);
		act.sendKeys(Keys.ARROW_DOWN).perform();
		act.sendKeys(Keys.ENTER).perform();
