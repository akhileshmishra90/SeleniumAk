...
public class SqProposalPrint {
	...
	@FindBy(id ="btnSaveandPrintProposal")
   ...
   public void sqPropPdf (String Customer_Id,String Product_Id,String Quantity,String unit_price,String taxCode) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
	 ...
	 Thread.sleep(4000);
	  ...
	  searchId.sendKeys(exp);
	   String act2 = actval.getText();
	    Assert.assertEquals(act2, exp,"Proposal print for SQ is saved after executing case == fail");
  		System.out.println("Proposal print for SQ is not saved after executing case == pass");
