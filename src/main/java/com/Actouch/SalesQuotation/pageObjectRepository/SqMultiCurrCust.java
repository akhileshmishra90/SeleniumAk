...
public class SqMultiCurrCust {
   ...
   public void sqMultiCurr (String Customer_Id,String Product_Id,String Quantity,String unit_price,String taxCode) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
	 ...
	 Thread.sleep(4000);
	  ...
	  searchId.sendKeys(exp);
	   String act2 = actval.getText();
	    Assert.assertEquals(act2, exp,"SQ with Multi Currency Customer not saved after executing case == fail");
  		System.out.println("SQ with Multi Currency Customer saved after executing case == pass");
