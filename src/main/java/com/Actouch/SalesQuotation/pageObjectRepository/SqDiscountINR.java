package com.Actouch.SalesQuotation.pageObjectRepository;
	...
	public class SqDiscountINR {
		...
		@FindBy(xpath ="//button/span[@data-bind='text: SQInventory.discType']")
		WebElement discType;
		@FindBy(xpath ="//a[@data-bind='click: SQInventory.discTypeClick2']")
	   ...
	   public void discountINR(String Customer_Id,String Product_Id,String Quantity,String unit_price, String taxCode,String Discount ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
