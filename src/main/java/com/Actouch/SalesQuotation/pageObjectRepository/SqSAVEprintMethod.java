...
public class SqSAVEprintMethod {
   ...
   public void savePrintMethod(String Customer_Id,String Product_Id,String Quantity,String unit_price,String taxCode) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
	 ...
	 Thread.sleep(4000);
	  ...
	  searchId.sendKeys(exp);
	   String act2 = actval.getText();
	    Assert.assertEquals(act2, exp,"SQ is not saved after executing case == fail");
