...
public class SQwithTradeDis {

	// soDiscountwith percentage
	...
	@FindBy(xpath ="//button/span[@data-bind='text: SQInventory.overallDiscType']")
	WebElement discType;
	@FindBy(xpath ="//a[@data-bind='click: SQInventory.discMethodClick2']")
	WebElement selectDiscType;
	
	
	@FindBy(id="overAllDisc")
	WebElement discTypeEdt;
   ...
   public void SqWithTradeDis(String Customer_Id,String Product_Id,String Quantity,String unit_price, String taxCode,String Discount ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
	 ...
	 discType.click();
	 Thread.sleep(100);
	 selectDiscType.click();
	 Thread.sleep(1000);
	 
	 discTypeEdt.sendKeys(Discount);
	 act.sendKeys(Keys.TAB).perform();
	 Thread.sleep(1000);
