...
public class SQTaxInclusive {
   ...
   public void sqTaxIncl (String Customer_Id,String Product_Id,String Quantity,String unit_price,String taxCode) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
	 ...
	 for(int i=1;i<10;i++)
	  ...
	  searchId.sendKeys(exp);
	   String act2 = actval.getText();
	    Assert.assertEquals(act2, exp,"Product tax exclusive not saved after executing case == fail");
  		System.out.println("Product tax exclusive saved after executing case == pass");
