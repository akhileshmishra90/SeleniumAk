...
import java.io.IOException;
 ...
 public class SQWithSaleTax  {
		...
		@FindBy(id ="SQCFormTaxList-select")
		WebElement cstTaxEdt;
	   ...
	   public void salesTax (String Customer_Id,String Product_Id,String Quantity,String unit_price,String taxCode, String cstTax) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
		 ...
		 for(int i=1;i<10;i++)
		    ...
		    Assert.assertEquals(act2, exp,"SQ saved but not verified SQ ID after executing case == fail");
