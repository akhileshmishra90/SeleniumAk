	...
	WebElement Service;
	  ...
	  @FindBy(xpath="//label[@data-bind ='html: DIService.totalAmt']")
	   ...
	   WebElement 	SaveEdt;
		...
		public void payLtr(String Cust,String Desc,String Category,String Unitprice,String SalePerson) throws InterruptedException
		{
		...
		SalePersonEdt.sendKeys(SalePerson);
