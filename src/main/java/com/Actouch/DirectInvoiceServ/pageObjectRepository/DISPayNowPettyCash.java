...
public class DISPayNowPettyCash {
	...
	@FindBy(xpath="//label[@data-bind ='html: DIService.totalAmt']")
	   ...
	   WebElement SaveEdt;
		...
		public void payLtr(String Cust,String Desc,String Category,String Unitprice,String Paytype,String paymode) throws InterruptedException
		{
