...
public class DISPayNowMultiChq {
		...
		WebElement Service;
		  ...
		  @FindBy(id="payType")
		   ...
		   WebElement SaveEdt;
			...
			public void payLtr(String Cust,String Desc,String Category,String Unitprice,String Paytype,String paymode,String ChequeNo,String RecvdbankName,String ChequeNo2,String Recvbank2) throws InterruptedException
			{
