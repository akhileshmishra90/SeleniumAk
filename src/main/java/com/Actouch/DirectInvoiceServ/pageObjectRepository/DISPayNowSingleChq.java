...
public class DISPayNowSingleChq {
	...
	WebElement Service;
	  ...
	  @FindBy(id="payType")
	   ...
	   WebElement SaveEdt;
		...
		public void payLtr(String Cust,String Desc,String Category,String Unitprice,String Paytype,String paymode,String ChequeNo,String RecvdbankName ) throws InterruptedException
		{
