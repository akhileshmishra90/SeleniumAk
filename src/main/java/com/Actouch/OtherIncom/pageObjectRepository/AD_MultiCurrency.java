...
public class AD_MultiCurrency {
	...
	WebElement Result;
	public void ReceiveAdvancedCur(String CustId,String Description,String Amount,String Currency,String ExchangeRt ) throws InterruptedException
	{
