...
public class OI_TDSDeduct {
	...
	WebElement Result;
	public void ReceiveIncomeTDS(String CustId,String Description,String Category,String Amount,String taxCode ) throws InterruptedException
	{
