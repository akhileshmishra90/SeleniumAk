...
public class OE_MultiCurrency {
   ...
   WebElement Result;	
	public void PayExpensesCurrency(String Suppl,String Desc,String Category,String Amount, String Currency,String Exchange) throws InterruptedException
	{
