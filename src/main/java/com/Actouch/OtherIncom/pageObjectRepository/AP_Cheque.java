...
public class AP_Cheque {
   ...
   @FindBy(xpath=".//*[@id='APTable']/tbody/tr/td[2]/a")
    WebElement Result;	
	public void PayAdvancedCheque(String Suppl,String Desc,String Amount,String BankName,String ChequeNo ) throws InterruptedException
	{
