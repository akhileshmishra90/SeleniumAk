...
public class AD_ReceiveAdvanced {
	...
	WebElement Result;
	public void ReceiveAdvanced(String CustId,String Description,String Amount ) throws InterruptedException
	{
...
DashCustEdt.sendKeys(Exp);
	...
	SearchAR.sendKeys(Excepted);
		String actual = Result.getText();
		 Assert.assertEquals(actual, Excepted, "Receive Advanced ==fail");
		 System.out.println("Receive Advanced ==pass");
	}
