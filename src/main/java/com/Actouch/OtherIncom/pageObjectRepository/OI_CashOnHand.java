...
public class OI_CashOnHand {
	...
	WebElement Result;
	public void ReceiveIncomeCash(String CustId,String Description,String Category,String Amount,String payMode ) throws InterruptedException
	{
