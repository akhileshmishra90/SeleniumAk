...
public class OI_DisINR {
	...
	@FindBy(xpath="//span[@data-bind='text: OIModel.discType2']")
	WebElement InrType;
	@FindBy(xpath="//span[@data-bind='text: OIModel.overallDiscUnit']")
	...
	WebElement Result;
	public void ReceiveIncomeDisINR(String CustId,String Description,String Category,String Amount,String payMode,String Discount ) throws InterruptedException
	{
