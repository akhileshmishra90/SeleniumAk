package com.Actouch.SalesINVSite.pageObjectRepository;
	...
	public class SOMultiproduct {
		 ...
		 public static String totalTaxamt;
		    ...
		    static SO_Excellib SO_Excellib = new SO_Excellib("D:\\Selenium\\SaleOrderSite.xlsx");
		...
		String qty = SO_Excellib.getExcelDat("Multi", l, 13);
				 	...
				 	if(j == 1)                  //Inventory_product
		                       	{
				  	             Browser.driver.findElement(By.xpath(".//*[@id='SODetailsTable']/tbody/tr["+j+"]/td[5]/div[1]/div[1]/input")).sendKeys(qty);
				  	...
				  	totalTaxamt=SOC.totalTaxEdt();
						...
						SOC.btnSaveEdt();
						 ...
						 act.sendKeys(Keys.TAB).perform();
				  		  ...
				  		  Thread.sleep(2000);
				  		   String act2 = SOB.actval();
				  		 softAssertion.assertEquals(act2, exp,"multi product after saving case == fail");
				  		softAssertion.assertAll();
				  	  	
			}
			public static void payltrDB (String databaseURL,String user,String password,String query,String CustID, String CustName,String Total,String TotalTax) throws Exception
			{
				connection = null;
