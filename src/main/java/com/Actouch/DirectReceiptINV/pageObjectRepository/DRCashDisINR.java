...
public class DRCashDisINR {
	  ...
	  public static String amt;
		...
		WebElement TaxModel;
		@FindBy(xpath="//span[@data-bind='text: DPInventory.discType']")
		WebElement DiscType;
		@FindBy(xpath="//span[@data-bind='text: DPInventory.discType2']")
		WebElement INRType;
		@FindBy(id="overAllDisc")
		WebElement DisINREdt;
		...
		WebElement Result;
		public void CrdTerm(String Supp,String ProdID,String Qnty,String UnitP,String TaxCode,String DisINR) throws InterruptedException
		{
			...
			String count1=Browser.driver.findElement(By.xpath("//table[@id='taxCalc']/tbody/tr["+i+"]/td[2]/input[@id ='taxId'] ")).getAttribute("value");
			  ...
			  DisINREdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),DisINR);
