...
public class DRAdvChq {
	 public static String amt;
		...
		WebElement Result;
		public void Payltr(String Supp,String ProdID,String Qnty,String UnitP,String TaxCode,String AdvAmt,String Paymode,String ChequeNo) throws InterruptedException
		{
			...
			String count1=Browser.driver.findElement(By.xpath("//table[@id='taxCalc']/tbody/tr["+i+"]/td[2]/input[@id ='taxId'] ")).getAttribute("value");
			  ...
			  ChequeEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),ChequeNo);
			  Savecheq.click();
