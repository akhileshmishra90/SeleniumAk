...
public class UPDRShipAddress {
    ...
    WebElement Result;
    public void SuppID (String UPShip) throws InterruptedException
    {
 	  ...
 	  UPShipEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),UPShip);
 	 String  Expected =UPShipEdt.getAttribute("value") ;
 	  amt=Total.getText();
 	   Save.click();
 	   OkEdt.click();
