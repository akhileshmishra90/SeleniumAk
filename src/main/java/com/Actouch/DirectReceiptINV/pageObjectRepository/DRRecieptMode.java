...
public class DRRecieptMode {
	      public static String amt;
			...
			WebElement Result;
			public void CrdTerm(String Supp,String ProdID,String Qnty,String UnitP,String TaxCode,String ReceiptMode) throws InterruptedException
			{
				...
				String count1=Browser.driver.findElement(By.xpath("//table[@id='taxCalc']/tbody/tr["+i+"]/td[2]/input[@id ='taxId'] ")).getAttribute("value");
				  ...
				  RedeiptModeEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),ReceiptMode);
