...
public class UPDRMemo {
    ...
    WebElement Result;
    public void SuppID (String UPMemo) throws InterruptedException
    {
 	  ...
 	  UPMemotEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),UPMemo);
 	 String  Expected =UPMemotEdt.getAttribute("value") ;
 	  amt=Total.getText();
 	   Save.click();
 	   OkEdt.click();
