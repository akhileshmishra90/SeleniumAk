...
public class DRTradeDis {
	   ...
	   public static String amt;
		...
		WebElement TaxModel;
		@FindBy(xpath="//span[@data-bind='text: DPInventory.overallDiscType']")
		WebElement DiscType;
		@FindBy(xpath="//span[@data-bind='text: DPInventory.discMethodType2']")
		WebElement DiscMethod;
		@FindBy(id="overAllDisc")
		WebElement DisPerEdt;
		...
		WebElement Result;
		public void CrdTerm(String Supp,String ProdID,String Qnty,String UnitP,String TaxCode,String DisTrade) throws InterruptedException
		{
			...
			String count1=Browser.driver.findElement(By.xpath("//table[@id='taxCalc']/tbody/tr["+i+"]/td[2]/input[@id ='taxId'] ")).getAttribute("value");
			  ...
			  act.moveToElement(DiscMethod).click().perform();
			  DisPerEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),DisTrade);
