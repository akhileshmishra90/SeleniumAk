...
public class DRMuomBatchable {
	 ...
	 public static String amt;
	    ...
	    @FindBy(id="batchNo")
	    WebElement BatchEdt;
	    @FindBy(xpath="//tbody[@data-bind='foreach: batchList']/tr[1]/td[5]/span/input")	
		WebElement SecMuomEdt;
	    @FindBy(id="sqty")
	    WebElement SecQtyEdt;
	     @FindBy(xpath="//td[@data-bind='visible: !isSerialNo()']/input")
		WebElement PrimQntyEdt;
       ...
       @FindBy(xpath="//label[@data-bind='html: DPInventory.netAmt']")
		...
		WebElement Result;
		public void BatchMuom(String Supp,String ProdID,String Batch,String SecMuom,String SecQty, String PrimQnty,String UnitP,String TaxCode) throws InterruptedException
		{
			...
			prodModEdt.click();
			BatchEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),Batch);
			SecMuomEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),SecMuom);
			act.sendKeys(Keys.ARROW_DOWN).perform();
			act.sendKeys(Keys.ENTER).perform();
			SecQtyEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),SecQty);
			PrimQntyEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),PrimQnty);
			QtySave.click();
