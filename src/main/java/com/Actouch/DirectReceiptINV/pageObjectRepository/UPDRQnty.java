...
public class UPDRQnty {
    ...
    @FindBy(xpath="//label[@data-bind='text:purQty']")
    WebElement Result;
    public void SuppID (String UPQnty) throws InterruptedException
    {
 	  ...
 	  UPQntyEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),UPQnty);
 	 String  Expected =UPQntyEdt.getAttribute("value") ;
