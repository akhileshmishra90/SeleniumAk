...
public class DRCreditTerm {
      public static String amt;
		...
		WebElement Result;
		public void CrdTerm(String Supp,String CrdTerm,String ProdID,String Qnty,String UnitP,String TaxCode) throws InterruptedException
		{
			...
			CrdTermEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),CrdTerm);
