...
public class DRMultiCurrency 
{
	 public static String amt;
		...
		WebElement SuppEdt;
		@FindBy(xpath="//div[@id='crepo-formp-1']/div[3]/div/div[4]/span[2]/input")
	   ...
	   @FindBy(xpath="//label[@data-bind='html: DPInventory.netAmt']")
		...
		WebElement Result;
		public void CrdTerm(String Supp,String Currency,String exchRate,String ProdID,String Qnty,String UnitP,String TaxCode) throws InterruptedException
		{
			...
			CurrencyEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),Currency);
			act.sendKeys(Keys.ARROW_DOWN).perform();
			act.sendKeys(Keys.ENTER).perform();
			if(!(Currency.equals("INR")))
		    exchRateEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),exchRate);
