...
public class DRPurchaseTax {
      public static String amt;
		...
		WebElement Result;
		public void CrdTerm(String Supp,String ProdID,String CSTPurchase,String Qnty,String UnitP,String TaxCode,String PurTax) throws InterruptedException
		{
			...
			CSTPurchaseEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),CSTPurchase);
			...
			act.sendKeys(Keys.TAB).perform();
			Thread.sleep(2000);
			wait.until(ExpectedConditions.visibilityOf(prodModEdt));
			prodModEdt.click();
			...
			String count1=Browser.driver.findElement(By.xpath("//table[@id='taxCalc']/tbody/tr["+i+"]/td[2]/input[@id ='taxId'] ")).getAttribute("value");
			  ...
			  PurTaxEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),PurTax);
			  act.sendKeys(Keys.ARROW_DOWN).perform();
				act.sendKeys(Keys.ENTER).perform();
