...
public class UPDRShipCharge {
    ...
    @FindBy(xpath="//label[@data-bind='html: PORInventory.shipCharges']")
    WebElement Result;
    public void SuppID (String UPshpCharge) throws InterruptedException
    {
 	  ...
 	  UPshpChargeEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),UPshpCharge);
 	 String  Expected =UPshpChargeEdt.getAttribute("value") ;
