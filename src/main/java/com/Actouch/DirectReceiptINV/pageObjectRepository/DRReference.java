...
public class DRReference {
  public static String amt;
   ...
   @FindBy(xpath="//label[@data-bind='html: DPInventory.netAmt']")
	...
	WebElement Result;
	public void CrdTerm(String Supp,String OrRef,String PoRefAmt,String ProdID,String Qnty,String UnitP,String TaxCode) throws InterruptedException
	{
		...
		OrRefEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),OrRef);
	    PoRefAmtEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),PoRefAmt);
