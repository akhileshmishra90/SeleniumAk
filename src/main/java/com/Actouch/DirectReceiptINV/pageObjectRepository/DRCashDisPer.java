...
public class DRCashDisPer {
	   ...
	   public static String amt;
		...
		WebElement Result;
		public void CrdTerm(String Supp,String ProdID,String Qnty,String UnitP,String TaxCode,String DisPer) throws InterruptedException
		{
			...
			String count1=Browser.driver.findElement(By.xpath("//table[@id='taxCalc']/tbody/tr["+i+"]/td[2]/input[@id ='taxId'] ")).getAttribute("value");
			  ...
			  DisPerEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),DisPer);
