...
public class DRTermCond {
	 ...
	 public static String amt;
		...
		WebElement TaxModel;
		@FindBy(xpath="//div[@data-bind='click: DPInventory.showTermsConditionModal']")
		WebElement TCModel;
       ...
       @FindBy(xpath="//label[@data-bind='html: DPInventory.netAmt']")
		...
		WebElement Result;
		public void CrdTerm(String Supp,String ProdID,String Qnty,String UnitP,String TaxCode,String tc) throws InterruptedException
		{
			...
			String count1=Browser.driver.findElement(By.xpath("//table[@id='taxCalc']/tbody/tr["+i+"]/td[2]/input[@id ='taxId'] ")).getAttribute("value");
			  ...
			  TCModel.click();
			  TCEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),tc);
			  TCOKEdt.click();
