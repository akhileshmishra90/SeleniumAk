...
public class UPDRShipTax {
  public static String amt;
    ...
    WebElement Result;
    public void SuppID (String UPshpTax) throws InterruptedException
    {
 	  ...
 	  UPPOShipTaxEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),UPshpTax);
 	  act.sendKeys(Keys.ARROW_DOWN).perform();
 	  act.sendKeys(Keys.ENTER).perform();
 	 String  Expected =UPPOShipTaxEdt.getAttribute("value") ;
 	 act.sendKeys(Keys.ENTER).perform();
 	  amt=Total.getText();
 	   Save.click();
 	   OkEdt.click();
