...
public class UPSRVRCVServicePrice {
	 ...
	 @FindBy(xpath="//input[@aria-controls='POTable']")
		...
		@FindBy(xpath="//label[@data-bind='text : recdQty")
		WebElement Result;
		public void Supplier(String ServicePrice) throws InterruptedException
		{
			...
			Thread.sleep(3000);
			SelectProd.click();
			POServicepriceEdt.sendKeys(Keys.chord(Keys.CONTROL,"a"),ServicePrice);
		    act.sendKeys(Keys.ENTER).perform();
		    String Expected=POServicepriceEdt.getAttribute("value");
		    Save.click();
		    okEdt.click();
		    Thread.sleep(3000);
		    SearchPOR.sendKeys(Exp);
