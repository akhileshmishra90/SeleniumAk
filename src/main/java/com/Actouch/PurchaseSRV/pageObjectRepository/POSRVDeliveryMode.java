...
public class POSRVDeliveryMode {
	...
	@FindBy(id="POServiceshipMode-select")
	WebElement DeliveryModeEdt;
	...
	WebElement actval;
	public void DeliverMode(String Supp,String Desc,String Category,String Unitprice,String ShipMode  ) throws InterruptedException
	{
		...
		act.sendKeys(Keys.ENTER).perform();
		DeliveryModeEdt.sendKeys(Keys.chord(Keys.CONTROL, "a"),ShipMode);
		act.sendKeys(Keys.ARROW_DOWN).perform();
		act.sendKeys(Keys.ENTER).perform();
