...
public class POSRVDisINR {
	...
	@FindBy(xpath="//span[@data-bind='text: POService.discType2']")
	WebElement InrType;
	...
	WebElement actval;
	public void PayDisINR(String Supp,String Desc,String Category,String Unitprice,String Discount) throws InterruptedException
	{
