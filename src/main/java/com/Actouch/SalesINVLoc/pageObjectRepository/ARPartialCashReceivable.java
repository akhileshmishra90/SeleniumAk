...
public class ARPartialCashReceivable {
...
public void PartialReceivable(String Amount) throws InterruptedException
{
...
SearchAR.sendKeys(Excepted );
	String actual = Result.getText();
	 Assert.assertEquals(actual, Excepted, "partail Receivable ==fail");
	 System.out.println("partail Receivable == pass");
}
