...
public class SOShipmentByCargo {
	//Shipment By cargo
	public static String amt;
	   ...
	   WebElement actval;
	   public void ShpByCargo(String Customer_Id,String Product_Id,String Quantity,String unit_price,String taxCode ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
		 ...
		 btnSaveEdt.click();
		  ...
		  Thread.sleep(7000);
		   ...
		   String act2 = actval.getText();
		    Assert.assertEquals(act2, exp,"Shipment By Cargo after saving case == fail");
	  		System.out.println("Shipment By Cargo after saving case == pass");
	}
