...
WebElement taxModel;
   ...
   public void partialTax(String ShipQnty,String Newtaxcode) throws InterruptedException
   {
    ...
    WebDriverCommonlib.waitForElementPresent(CustIdShpedt);
  	...
  	act.sendKeys(Keys.TAB).perform();
  	 WebDriverCommonlib.waitForElementPresent(SearchforSo);
  	 Thread.sleep(1000);
  ...
  Thread.sleep(2000);
	...
	issueQnty.sendKeys(ShipQnty);
	  ...
	  taxModel.click();	
	  List <WebElement> Checkboxes = Browser.driver.findElements(By.id("chkTaxId"));
      ...
      WebDriverCommonlib.waitForElementPresent(taxModel);
      taxModel.click();
   for(int i=1;i<10;i++)
	  {
