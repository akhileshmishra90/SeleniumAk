...
public class SOMUOMProduct {
   ...
   WebElement actval;
   public void muomprod(String Customer_Id,String Product_Id,String Quantity,String unit_price,String IssueUOM,String taxCode  ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
