...
public class SOwithTradeDis {
	// soDiscountwith Trade
		public static String amt;
	   public void SoWithTrade(String Customer_Id,String Product_Id,String Quantity,String unit_price, String taxCode,String Discount ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
