...
public class SOAltUOM {
	...
	@FindBy(xpath="//div[@data-bind='ifnot:isCalOnSec']/span[2]/input") 
	WebElement SelUOM;
	@FindBy(xpath="//span[text()='Product Details']")
	WebElement prDetailsEdt;
	@FindBy(xpath=".//*[@id='taxCalc']/tbody/tr/td[1]/input")
	...
	WebElement actval;
	 public void aLTuom(String Customer_Id,String Product_Id,String UOM,String Quantity,String unit_price ) throws InterruptedException
	 {
		 ...
		 Actions act = new Actions(Browser.driver);
		  ...
		  Thread.sleep(1000);
		    ...
		    JavascriptExecutor kl = (JavascriptExecutor)Browser.driver;
			   ...
			   Thread.sleep(1000);
			   act.sendKeys(Keys.TAB).perform();
			   SelUOM.sendKeys(Keys.chord(Keys.CONTROL,"a"),UOM);
