...
@FindBy(xpath="//label[@data-bind='html: SOInventory.totalAmt']")
   ...
   WebElement actval;
   public void ShpByAir(String Customer_Id,String Product_Id,String Quantity,String unit_price,String taxCode ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
