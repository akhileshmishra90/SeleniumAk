...
public class SOBatchCurrencyDis {
   ...
   public void ProdTaxDis(String CustId,String ProdId,String Batch,String Quantity,String unitPrice,String Discount) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
   {
	 ...
	 prdSo_1Edt.sendKeys(ProdId);
	   Thread.sleep(2000);
     	act.sendKeys(Keys.TAB).perform();
	    prDetailsEdt.click();
	    Browser.driver.findElement(By.id("serInp1")).sendKeys(Batch);
	    Browser.driver.findElement(By.xpath(".//*[@id='taxCalc']/tbody/tr/td[1]/input")).click();
		  Browser.driver.findElement(By.xpath(".//*[@id='taxCalc']/tbody/tr/td[13]/input")).sendKeys(Quantity);
//	    for (int i= 1;i<=10;i++)
//		   {
