...
public class SOShipmentByRail {
	...
	public static String amt;
	   ...
	   WebElement actval;
	   public void ShpByRail(String Customer_Id,String Product_Id,String Quantity,String unit_price,String taxCode ) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	   {
		...
		amt = gettingTotalAmount.getText();
		  ...
		  Thread.sleep(7000);
		   ...
		   String act2 = actval.getText();
		    Assert.assertEquals(act2, exp,"Shipment By Rail after saving case == fail");
	  		System.out.println("Shipment By Rail after saving case == pass");
		  }
}
