...
public class SRPartial {
	...
	WebElement afterRSO;
	 ...
	 WebElement Result;
	public void partialReturn(String SRQnty) throws InterruptedException
      {
          ...
          Actions act = new Actions(Browser.driver);
	    	...
	    	act.moveToElement(ActionsforSR).click().perform();	    	
	    	SRReturnpg.click();	    	
