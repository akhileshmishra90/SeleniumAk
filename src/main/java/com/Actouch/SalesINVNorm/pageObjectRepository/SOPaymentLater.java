...
public class SOPaymentLater {
	...
	public void payltr(String Customer_Id,String Product_Id,String Quantity,String unit_price,String taxCode) throws InterruptedException
	{
		...
		SOC.taxEdt();
		 for(int i=1;i<10;i++)
		  {
		String count1=Browser.driver.findElement(By.xpath("(.//*[@id='taxId'])["+i+"] ")).getAttribute("value");
			  if(count1.equals(taxCode)){
				Browser.driver.findElement(By.xpath("(.//*[@id='chkTaxId'])["+i+"]")).click();
